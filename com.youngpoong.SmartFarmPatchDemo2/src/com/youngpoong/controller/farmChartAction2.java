...
public class farmChartAction2 implements Action {
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<farmDto> list = fDao.getAvgOCN_Week(userId);

		if(list != null) {
			request.setAttribute("list", list);
			forward.setNextPage("farmChart4.do");
